movelist = {"A", "B", "Up", "Down", "Left", "Right", "Start"}
joy = {}
joy["Power"] = "False"
joy["Select"] = "False"
...
for i = 1, 10 do
	...
	while emu.framecount() < frames do
		detmoves(population[i][2])
		setjoy(population[i][2])
		emu.frameadvance()
	end
	population[i][1] = 10000*mainmemory.readbyte(0x00A2) + 100*mainmemory.readbyte(0x00A1) + mainmemory.readbyte(0x00A0)
end
bulbasaur()
for i = 1, 5 do
